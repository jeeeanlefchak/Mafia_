...
public class Veiculos {
    ...
    public void carregarVeiculos() {
        ...
        carro.sprite.iMirror = AGSprite.VERTICAL;
        ...
        carro.sprite.vrPosition.setX(posicoesFaixas.get(1));
        carro.sprite.vrPosition.setY(AGScreenManager.iScreenHeight + (AGScreenManager.iScreenHeight / 2));
        carro.sprite.vrDirection.setY(-1);
        carro.sprite.iMirror = AGSprite.VERTICAL;
        carro.velocidadeRelativa = 25;
        veiculos.add(carro);
        carro = new Veiculo();
        carro.sprite = this.scene.createSprite(R.mipmap.car_traffic2,1,1);
        carro.sprite.setScreenPercent(10,15);
        carro.sprite.vrPosition.setX(posicoesFaixas.get(2));
        ...
        carro.sprite.setScreenPercent(10,15);
        carro.sprite.vrPosition.setX(posicoesFaixas.get(3));
        carro.sprite.vrPosition.setY(AGScreenManager.iScreenHeight + (AGScreenManager.iScreenHeight / 2));
        carro.sprite.vrDirection.setY(-1);
